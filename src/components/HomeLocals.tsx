      ...
      <section className="home_fundations_pagination" data-cy="home_locals_pagination_page">
        <div className="first_pagination_page">
          ...
          <article className="second_pagination_page_articles">
            <p className="fundation">Zbiórka “Lorem Ipsum 2”</p>
            <div className="wrapper">
          ...
          <article className="third_pagination_page_articles third_article_locals">
            <p className="fundation">Zbiórka “Lorem Ipsum 3”</p>
            <div className="wrapper">
